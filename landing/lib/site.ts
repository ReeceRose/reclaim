...
export const site = {
  ...
  description:
    "Self-hosted codec audit and re-encode tool for homelabs. Point it at the movie and TV folders Plex, Jellyfin, or Emby already use, rank files by predicted HEVC or AV1 savings, see which are better re-downloaded than re-encoded, and manually queue overnight ffmpeg jobs.",

          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <LabelWithHelp
                ...
                help={
                  <>
                    <strong>Constant Rate Factor</strong> — the quality target
                    for libx265. Lower means higher quality and bigger files;
                    higher means more compression and smaller files. Range is
                    0–51; <strong>24–28</strong> is the sweet spot for
                    visually-lossless HEVC. Each +6 roughly halves the bitrate.
                  </>
                }
              />
              <Input
            ...
            <div>
              <LabelWithHelp
                ...
                help={
                  <>
                    Encoder speed vs. compression efficiency. Slower presets
                    squeeze out more savings at the same CRF but take longer to
                    encode. <strong>medium</strong> is a balanced default;{" "}
                    <strong>slow</strong>/<strong>slower</strong> gain a few
                    extra percent, while <strong>fast</strong>/
                    <strong>veryfast</strong> trade file size for shorter encode
                    times.
                  </>
                }
              />

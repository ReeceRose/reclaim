...
export function LogoMark({
  ...
  return (
    ...
    >
      ...
      <rect x="0" y="0" width="256" height="256" rx="58" fill={`url(#${scan})`} />
      <rect x="0.75" y="0.75" width="254.5" height="254.5" rx="57.25" fill="none" stroke="#ffffff" strokeOpacity="0.06" />

      <rect x="60" y="62" width="136" height="132" rx="18" fill="none" stroke="#2e6ce0" strokeWidth="11" />

      <g stroke="#4589ff" strokeWidth="13" strokeLinecap="round" strokeLinejoin="round" fill="none">
